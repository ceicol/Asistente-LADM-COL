...
class EnumQualityRule:
    ...
    class Logic(Enum):
        ...
        FDC_PARCEL_WITH_MORE_THAN_ONE_ASSOCIATED_PLOT = 4224
        FDC_RIGHT_BROKEN_RELATION_WITH_FDC_PARCEL = 4225
        FDC_PARTY_BROKEN_RELATION_WITH_FDC_RIGHT = 4226
        FDC_ADMINISTRATIVE_SOURCE_RIGHT_BROKEN_RELATION_WITH_FDC_RIGHT = 4227
        FDC_ADMINISTRATIVE_SOURCE_BROKEN_RELATION_WITH_FDC_RIGHT = 4228
        EXT_ADDRESS_BROKEN_RELATION_WITH_FDC_PARCEL = 4229
        FDC_HOUSING_MARKET_OFFERS_BROKEN_RELATION_WITH_FDC_PARCEL = 4230
        FDC_RESTRICTION_BROKEN_RELATION_WITH_FDC_PARCEL = 4231
        FDC_BUILDING_BROKEN_RELATION_WITH_FDC_PARCEL = 4232
        FDC_BUILDING_UNIT_BROKEN_RELATION_WITH_FDC_BUILDING = 4233
        FDC_PARTY_WITH_INVALID_DOCUMENT_NUMBER = 4234
